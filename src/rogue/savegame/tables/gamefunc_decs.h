...
extern void weapon_flaregun_fire(edict_t* ent);
...
extern void flare_sparks(edict_t* self);
extern void flare_think(edict_t* self);
extern void flare_touch(edict_t* ent, edict_t* other, cplane_t* plane, csurface_t* surf);
extern void fire_flaregun(edict_t* self, vec3_t start, vec3_t aimdir, int damage, int speed, float timer, float damage_radius);
