...
#define SBT_RGEN_REFLECT_REFRACT 1
#define SBT_RGEN_DIRECT_LIGHTING 2
#define SBT_RGEN_DIRECT_LIGHTING_CAUSTICS 3
#define SBT_RGEN_INDIRECT_LIGHTING_FIRST 4
#define SBT_RGEN_INDIRECT_LIGHTING_SECOND 5
#define SBT_RMISS_PATH_TRACER 6
#define SBT_RMISS_SHADOW 7
#define SBT_RCHIT_OPAQUE 8
#define SBT_RAHIT_PARTICLE 9
#define SBT_RAHIT_BEAM 10
#define SBT_RAHIT_EXPLOSION 11
#define SBT_RAHIT_SPRITE 12
#define SBT_RCHIT_EMPTY 13
