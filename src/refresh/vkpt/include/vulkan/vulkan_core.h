...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_HIT_SHADER_MODULE_CREATE_INFO_NV = 1000165010,
    VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_NV = 1000165011,
    VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_INFO_NV = 1000165012,
    VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT = 1000174000,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINTER_CAST_TO_POINTER_FEATURES_KHR = 1000176000,
...
typedef void (VKAPI_PTR *PFN_vkGetPhysicalDevicePortabilitySubsetDataKHR)(VkPhysicalDevice physicalDevice, VkBaseOutStructure* pData);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vkGetPhysicalDevicePortabilitySubsetDataKHR(
    VkPhysicalDevice                            physicalDevice,
    VkBaseOutStructure*                         pData);
#endif
...
#define VK_KHR_POINTER_CAST_TO_POINTER_SPEC_VERSION 1
#define VK_KHR_POINTER_CAST_TO_POINTER_EXTENSION_NAME "VK_KHR_pointer_cast_to_pointer"

typedef struct VkPhysicalDevicePointerCastToPointerFeaturesKHR {
    VkStructureType    sType;
    void*              pNext;
    VkBool32           pointerCastToPointer;
